      ...
      <>
        ...
        <div className="confirmation-name-session">
          <div className="confirmation-ticket">
            ...
            {reservation.seat.map((p) => (
              <div key={p} className="confirmation-seat">
                Assento {p}
              </div>
            ))}
          </div>
        ...
        <div className="confirmation-name-session">
          <div className="confirmation-buyer">
            {reservation.compradores.map((p) => (
              <>
                <strong className="subtitle">Comprador</strong>
                <div className="confirmation-name">Nome: {p.nome}</div>
                <div className="confirmation-cpf">CPF: {p.cpf}</div>
              </>
            ))}
          </div>
        </div>
